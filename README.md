...
Navegue até a pasta do repositório e abra no Visual Studio Code, lembre-se de executar o comando `yarn` no seu terminal para instalar todas as dependências.
...
**Dica**: Caso você tenha dificuldades com a leitura de CSV, [confira este guia](https://www.notion.so/Importando-arquivos-CSV-com-Node-js-2172338480cb47e28a5d3ed9981c38a0).
